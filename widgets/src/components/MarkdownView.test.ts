 ...
 *
 * DEPENDENCY: These tests rely on generated test fixtures from generate_test_data.py
 * To regenerate fixtures: pnpm test:fixtures:generate
 * To list available fixtures: pnpm test:fixtures
 */
...
// Test fixtures generated by generate_test_data.py
